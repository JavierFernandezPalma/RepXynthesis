...
namespace Xynthesis.ServicioReportes
{
    public partial class Service1 : ServiceBase
    {
        ...
        private void LogService(string content)
        {
            ...
            {
                log.EscribaLog("LogService()_Error", "El error es : " + ex.ToString());
            }
        }
        ...
        public void validarEjecRepDiarioSemanal(long idReporte)
        {
            ...
            {
                log.EscribaLog("validarEjecRepDiarioSemanal()_Error", "El error es : " + ex.ToString());
            }
        ...
        public void validarEjecucionReporteMensual(long idReporte)
        {
            ...
            {
                log.EscribaLog("validarEjecucionReporteMensual()_Error", "El error es : " + ex.ToString());
            }
        }
        ...
        private void ejecutarReporteProgramado()
        {
            ...
            DateTime parametroUno = Convert.ToDateTime(fechaActual.ToString("yyyy-MM-dd") + " " + "00:00:00");
            DateTime parametroDos = Convert.ToDateTime(fechaActual.ToString("yyyy-MM-dd") + " " + "23:59:59");
            ...
            try
            {
                ...
                if (listaReportesHoy.Count != 0)
                {
                    foreach (var reporteVerificar in listaReportesHoy)
                    {
                        ...
                        if (Convert.ToDateTime(horaProgramada).TimeOfDay == Convert.ToDateTime(fechaActual.ToString("H:mm") + ":" + "00").TimeOfDay)
                        {
                            ...
                            if (lstReportes.Count() != 0)
                            {
                                try
                                {
                                    ...
                                    log.EscribaLog("ejecutarReporteProgramado()", "Ingresa a envío de correo...");
                                    ...
                                    log.EscribaLog("ejecutarReporteProgramado()", "Finalizo el metodo ejecutarReporteProgramado() y se envio reporte programado Id: " + reporteVerificar.ConfiguracionId.ToString() + " a las " + Convert.ToDateTime(fechaActual).TimeOfDay.ToString());
                                }
                                catch (Exception ex)
                                {
                        ...
                        {
                            log.EscribaLog("ejecutarReporteProgramado()", "Para reporte Id: " + reporteVerificar.ConfiguracionId.ToString() + " se realizara envío a las " + Convert.ToDateTime(horaProgramada).TimeOfDay.ToString());
                        }
            ...
            {
                log.EscribaLog("ejecutarReporteProgramado_Error", "El error es : " + ex.ToString());
            }
