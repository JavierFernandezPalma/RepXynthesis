...
{
    public class ReporteGraficoLlamadasEntrantesSalientesController : Xynthesis.Web.Models.FormatoReporte
    {
        ...
        { 
            ...
            //ViewData["usuario"] = xyt.xy_subscriber.ToList();
        ...
        public ActionResult Reportes(string opcion)
        {
            if (Session["FechaInicial"] == null || Session["FechaFinal"] == null)
                ...
                return ReporteFormato(opcion, "ReporteGraficoEstadisticoLlamadasEntrantesSalientes", "ObtenerListaLlamadasEntrantesSalientes",
        ...
        public JsonResult ConCober()
        {
            ...
            try
            {
                ...
                var res_ = from s in lista group s by s.Nom_Subscriber into grupo orderby grupo.Key select new { cob = grupo.Key, suma = grupo.Sum(r => Convert.ToDecimal(r.calls_answering)) };
